...
# 55 percent on
dir_55perc = joinpath(base_dir, "inference_results/inf_Fig_S3_S4_photoblink_55perc_on")
...
# 79 percent on
dir_79perc = joinpath(base_dir, "inference_results/inf_Fig_S3_S4_photoblink_79perc_on")
...
save_dir = "./figures/"
mkpath(save_dir)
save(joinpath(save_dir, "Fig_S4.pdf"), fig_err)
