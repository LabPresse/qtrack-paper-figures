...
dir_no_blink = joinpath(base_dir, "simulations/sim_Fig_S3_S4_no_photoblink")
...
# 45 percent on
dir_45perc = joinpath(base_dir, "simulations/sim_Fig_S3_S4_photoblink_45perc_on")
...
# 55 percent on
dir_55perc = joinpath(base_dir, "simulations/sim_Fig_S3_S4_photoblink_55perc_on")
...
# 79 percent on
dir_79perc = joinpath(base_dir, "simulations/sim_Fig_S3_S4_photoblink_79perc_on")
